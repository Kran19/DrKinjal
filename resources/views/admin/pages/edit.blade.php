...
<div class="mb-8">
    <div class="flex items-center space-x-3 mb-2">
        ...
        <h2 class="text-2xl font-bold text-stone-800">Edit Page</h2>
    </div>
    <p class="text-stone-600 ml-7">Modify "{{ $page->title }}"</p>
</div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="lg:col-span-2 space-y-6">
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-stone-100">
                <div class="mb-6">
                    ...
                    <input type="text" name="title" id="title" value="{{ old('title', $page->title) }}"
                           class="w-full border border-stone-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent transition-all @error('title') border-rose-500 @enderror"
            ...
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-stone-100">
                <h3 class="text-lg font-semibold text-stone-800 mb-6 flex items-center">
                    <i class="fas fa-search text-sky-500 mr-2"></i> SEO Settings
                </h3>
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <input type="text" name="meta_title" id="meta_title" value="{{ old('meta_title', $page->meta_title) }}"
                               class="w-full border border-stone-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent transition-all"
                    ...
                    <div>
                        ...
                        <textarea name="meta_description" id="meta_description" rows="4"
                                  class="w-full border border-stone-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-sky-500 focus:border-transparent transition-all"
                                  placeholder="Brief summary of the page for search engines">{{ old('meta_description', $page->meta_description) }}</textarea>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="space-y-6">
            <div class="bg-white p-6 rounded-2xl shadow-sm border border-stone-100">
                ...
                <div class="mb-8">
                    <label class="flex items-center cursor-pointer group">
                        <div class="relative">
                            <input type="checkbox" name="is_active" class="sr-only peer" {{ $page->is_active ? 'checked' : '' }}>
                            <div class="w-11 h-6 bg-stone-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-sky-300 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-stone-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-emerald-500"></div>
                        </div>
                ...
                <div class="flex flex-col space-y-3">
                    <button type="submit" class="btn-primary w-full py-3 justify-center shadow-lg shadow-sky-100">
            ...
            <div class="bg-amber-50 p-6 rounded-2xl border border-amber-100">
                <h4 class="text-amber-800 font-semibold mb-2 flex items-center">
                    <i class="fas fa-exclamation-triangle mr-2"></i> Reminder
                </h4>
                <p class="text-amber-700 text-sm leading-relaxed">
                    Changing the page title won't automatically update the URL slug. If you need to change the slug, please contact the developer.
                </p>
            </div>
        </div>
    </div>
