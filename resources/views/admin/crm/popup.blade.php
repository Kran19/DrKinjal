        ...
        <form id="popupForm" class="space-y-6">
            ...
            <div>
                <label class="flex items-center space-x-3">
                    <input type="checkbox" name="enabled" checked
                        class="rounded border-stone-300 text-sky-600 focus:ring-sky-500 h-5 w-5">
            ...
            <div>
                ...
                <div id="imageUploadArea" class="mt-2">
                    <!-- Upload Area -->
                    <div class="border-2 border-dashed border-stone-300 rounded-lg p-8 text-center hover:border-sky-400 transition-colors cursor-pointer"
