...
@section('content')
    ...
    @if (session('success'))
        <div class="mb-6 bg-emerald-50 border border-emerald-100 text-emerald-700 px-6 py-4 rounded-2xl flex items-center shadow-sm">
        ...
        <div class="overflow-x-auto">
            <table class="w-full">
                ...
                <tbody class="text-stone-600 text-sm font-medium">
                    ...
                    <tr class="border-b border-stone-50 hover:bg-sky-50/30 transition-colors">
                        <td class="py-4 px-8 text-left">
                            <div class="flex items-center space-x-3">
                                <div class="w-10 h-10 rounded-xl bg-sky-50 flex items-center justify-center text-sky-600 font-bold">
                        ...
                        <td class="py-4 px-8 text-center">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold {{ $testimonial->is_active ? 'bg-emerald-50 text-emerald-600 border border-emerald-100' : 'bg-rose-50 text-rose-600 border border-rose-100' }}">
                        ...
                        <td class="py-4 px-8 text-center">
                            <div class="flex items-center justify-center space-x-2">
                                <a href="{{ route('admin.testimonials.edit', $testimonial->id) }}" 
                                   class="w-9 h-9 flex items-center justify-center bg-sky-50 text-sky-600 rounded-xl hover:bg-sky-100 transition-all hover:scale-110 shadow-sm"
                                   title="Edit">
