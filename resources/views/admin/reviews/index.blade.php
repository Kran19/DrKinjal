            ...
            <table class="w-full">
                ...
                <tbody class="text-stone-600 text-sm font-medium">
                    ...
                    <tr class="border-b border-stone-50 hover:bg-sky-50/30 transition-colors">
                        ...
                        <td class="py-4 px-8 text-center">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-bold {{ $review->status ? 'bg-emerald-50 text-emerald-600 border border-emerald-100' : 'bg-rose-50 text-rose-600 border border-rose-100' }}">
